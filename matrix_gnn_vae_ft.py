...
class DecoderTheta(nn.Module):
    ...
    def forward(self, z):  # Changed from forward_with_epistemic(self, z, sigma, mu)
...
if __name__ == "__main__":
    ...
    torch.save(bnn_model.state_dict(), "ghost_bus_vae_aggregate_0.8_64h_ft.pt")
