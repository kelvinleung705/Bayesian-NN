...
# ==========================================
    ...
    # Running Errors (No bounds checking since there's no std dev)
    ...
    # ==========================================
    # 7. CLEANING, SMOOTHING AND PLOTTING (DETERMINISTIC)
    # ==========================================
    ...
    # Adjust early morning hours (if applicable to your logic)
    ...
    # 3. Apply LOWESS Smoothing to the Predictions
    smooth_frac = 0.01
    ...
    # B. The Mean ETA Line (Trend Forecast from Model)
    plt.plot(m_smooth[:, 0], m_smooth[:, 1], color='#e74c3c', linewidth=3, label='Deterministic ETA Forecast', zorder=3)

    # --- FORMATTING ---
    plt.title('Deterministic Transit ETA Forecast vs. Time of Day', fontsize=18, fontweight='bold', pad=20)
    ...
    output_filename = 'ghost_bus_final_results_deterministic_weekend_bad_traffic.png'
