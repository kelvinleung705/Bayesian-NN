...
if __name__ == "__main__":
    ...
    torch.save(bnn_model.state_dict(), "2024_Jul_Dec_vae_ft_student_t_0.7_WMATA_D40.pt")
    joblib.dump(scaler_y, "y_scaler_vae_student_t_2024_Jul_Dec_WMATA_D40.pkl")
