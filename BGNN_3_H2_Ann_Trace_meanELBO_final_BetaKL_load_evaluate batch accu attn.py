...
class NeighborMixingLayer(PyroModule):
    ...
    def forward(self, prev_layer_outputs):
        ...
        for i in range(self.num_segments):
            ...
            dynamic_weights = torch.sigmoid(raw_scores) * 2.0
            ...
            alpha_self = dynamic_weights[:, 0].unsqueeze(1)  # Shape: [Batch, 1]
            alpha_right = dynamic_weights[:, 1].unsqueeze(1) # Shape: [Batch, 1]
            print(alpha_self[0], alpha_right[0])
...
if __name__ == "__main__":
    ...
    saved_params_path = "ghost_bus_model_cycle_0.1_2000_df10_KL_9_accu_attn.pt" # Replace with exact saved params file name
