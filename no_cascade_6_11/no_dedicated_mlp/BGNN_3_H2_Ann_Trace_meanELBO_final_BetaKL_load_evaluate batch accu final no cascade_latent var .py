...
if __name__ == "__main__":
    ...
    saved_params_path = "ghost_bus_no_cascade.pt"
    print(saved_params_path)
    saved_scaler_path = "y_scaler_no_cascade.pkl"              # Replace with exact saved scaler file name
...
plt.tight_layout()
plt.savefig("no_cascade_latent_space.png", dpi=150, bbox_inches='tight')
plt.show()
print("Saved → no_cascade_latent_space.png")
...
plt.tight_layout()
plt.savefig("no_cascade_latent_centered_no_extreme.png", dpi=150)
plt.show()
...
plt.suptitle("Per-Sample N(m,u) — Median Centered", fontsize=13, fontweight="bold")
plt.tight_layout()
plt.savefig("no_cascade_latent_centered_no_extreme_color_variance.png", dpi=150)
plt.show()
...
plt.savefig('no_cascade_loc_vs_scale_median_centred_final.png', dpi=150, bbox_inches='tight')
plt.show()
