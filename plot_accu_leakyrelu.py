...
class LocalIsolationLayer(PyroModule):
    ...
    def forward(self, x_inputs):
        ...
        for i in range(self.num_segments):
            out = torch.nn.functional.leaky_relu(self.nets[i](x_inputs[i]))
            outputs.append(out)
...
if __name__ == "__main__":
    ...
    saved_params_path = "ghost_bus_model_cycle_0.1_2000_df10_KL_9_accu_leakyrelu.pt" # Replace with exact saved params file name
    #saved_scaler_path = "y_scaler_1.pkl"              # Replace with exact saved scaler file name
    saved_scaler_path = "y_scaler_leakyrelu.pkl"              # Replace with exact saved scaler file name
    ...
    output_filename = 'ghost_bus_accu2_results_bollinger_weekday_bad_weather_May.png'
