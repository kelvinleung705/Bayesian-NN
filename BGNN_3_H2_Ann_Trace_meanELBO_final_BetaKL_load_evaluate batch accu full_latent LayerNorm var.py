...
if __name__ == "__main__":
    ...
    #saved_params_path = "ghost_bus_BLL_LayerNorm.pt"
    saved_params_path = "ghost_bus_BLL_LayerNorm_new_cycle.pt"
    ...
    saved_scaler_path = "y_scaler_new_cycle.pkl"
...
plt.suptitle("Per-Sample N(m,u) — Median Centered", fontsize=13, fontweight="bold")
plt.tight_layout()
plt.savefig("latent_centered_no_extreme_color_variance_LayerNorm.png", dpi=150)
plt.show()
...
plt.savefig('loc_vs_scale_median_centred_full_LayerNorm.png', dpi=150, bbox_inches='tight')
plt.show()
print("Saved → loc_vs_scale_median_centred_full_LayerNorm.png")
