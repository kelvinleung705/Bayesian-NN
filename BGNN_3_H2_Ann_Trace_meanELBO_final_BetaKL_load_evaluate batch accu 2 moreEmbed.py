...
if __name__ == "__main__":
    ...
    saved_params_path = "ghost_bus_model_cycle_0.1_2000_df10_KL_9_accu_moreEmbed.pt" # Replace with exact saved params file name
    
    saved_scaler_path = "y_scaler_moreEmbed.pkl"              # Replace with exact saved scaler file name
