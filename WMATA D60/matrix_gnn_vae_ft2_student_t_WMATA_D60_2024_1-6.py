...
if __name__ == "__main__":
    ...
    torch.save(bnn_model.state_dict(), "2024_Jan_Jun_vae_ft_student_t_0.7_WMATA_D60.pt")
    joblib.dump(scaler_y, "y_scaler_vae_student_t_2024_Jan_Jun_WMATA_D60.pkl")
