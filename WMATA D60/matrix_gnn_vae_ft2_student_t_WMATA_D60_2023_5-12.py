...
if __name__ == "__main__":
    ...
    torch.save(bnn_model.state_dict(), "2023_May_Dec_vae_ft_student_t_0.7_WMATA_D60.pt")
    joblib.dump(scaler_y, "y_scaler_vae_student_t_2023_May_Dec_WMATA_D60.pkl")
