...
if __name__ == "__main__":
    ...
    def guide_fn(x_global, x_local, y_true=None, total_size=None, kl_weight=1.0):
        with pyro.poutine.scale(scale=kl_weight):
            return guide(x_global, x_local, y_true, total_size=total_size, kl_weight=kl_weight)
    ...
    for epoch in range(epochs):
        ...
        max_beta = 0.05  # Max KL weight (equivalent to saying "Data is 10x more important than Prior")
        ...
        if epoch % 1 == 0 or epoch == epochs - 1:
            ...
            print(f"Epoch {epoch:05d} | LR: {current_lr:.6f} | KL Wt: {current_kl_weight:.3f} | ELBO Loss: {avg_loss:.2f}")
