...
def process_validation_data(file_path, loaded_scaler):
    ...
    x_global_all = torch.tensor(x_global_np, dtype=torch.float32)
...
if __name__ == "__main__":
    ...
    saved_params_path = "ghost_bus_model_cycle_0.1_2000_df10_KL_9_accu_Jan_Feb_no_month.pt" # Replace with exact saved params file name
    saved_scaler_path = "y_scaler_Jan_Feb_no_month.pkl"              # Replace with exact saved scaler file name
    ...
    output_filename = 'ghost_bus_accu2_results_bollinger_Feb_weekday_bad_weather.png'
